<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewReference.aspx.cs" Inherits="AddNewClient" %>
                                                ...
                                                <div class="tab-content" style="direction:rtl" >
                                                    <div class="tab-pane active" role="tabpanel" id="step1">
                                                        ...
                                                        <div class="input-group">
                                                             <input id="" type="text" placeholder="הכנס את שם החוק החדש" class="form-control" value=""/>
                                                    ...
                                                    <div class="tab-pane" role="tabpanel" id="step2">
                                                        <h3>הכנס את לשון החוק</h3>
                                                        <p> טסקט החוק כפי שנכתב ע"י המחוקק </p>
                                                        <div class="input-group">
                                                            <textarea rows="7" cols="100" class="form-control" dir="rtl">הכנס את טקסט החוק החדש</textarea>
                                                        </div>
                                                        <br />
                                                        <ul class="list-inline pull-left">
                                                            <li>
                                                    ...
                                                    <div class="tab-pane" role="tabpanel" id="step3">
                                                        <h3>הכנס פסיקות רלוונטיות לחוק החדש</h3>
                                                        <p>הוסף פסיקה </p>
                                                        <div class="input-group">
                                                             <textarea rows="7" cols="100" class="form-control" dir="rtl">הכנס את טקסט הפסיקה</textarea>
                                                        </div>
                                                        <button type="button" class="btn btn-default prev-step">הוסף</button>
                                                       <br />
                                                        <br />
                                                        <h3>הכנס אסמכתאות רלוונטיות לחוק החדש</h3>
                                                        <p>הוסף אסמכתא </p>
                                                        <div class="input-group">
                                                             <textarea rows="7" cols="100" class="form-control" dir="rtl">הכנס את טקסט האסמכתא</textarea>
                                                    ...
                                                    <div class="tab-pane" role="tabpanel" id="complete">
                                                        <h3>תהליך הוספת חוק חדש הושלם</h3>
                                                        <p>החוק נוסף למערכת</p>
                                                    </div>
